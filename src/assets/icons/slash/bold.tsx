...
export const Bold: FC<IBoldProps> = ({ className }) => {
  return (
    ...
    >
      ...
      />
      <path
        d="M22.0001 12C22.0001 17.49 17.4901 22 12.0001 22C10.5001 22 9.0801 21.67 7.8001 21.07C7.1801 20.78 7.0601 19.95 7.5401 19.46L19.4601 7.54001C19.9401 7.06001 20.7801 7.18001 21.0701 7.80001C21.6701 9.07001 22.0001 10.5 22.0001 12Z"
        fill="#292D32"
      />
      <path
