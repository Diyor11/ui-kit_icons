...
export const Outline: FC<IOutlineProps> = ({ className }) => {
  return (
    ...
    >
      ...
      />
      <path
        d="M7.2 22.75H4.8C2.38 22.75 1.25 21.62 1.25 19.2V15.91C1.25 13.49 2.38 12.36 4.8 12.36H7.2C9.62 12.36 10.75 13.49 10.75 15.91V19.2C10.75 21.62 9.62 22.75 7.2 22.75ZM4.8 13.86C3.21 13.86 2.75 14.32 2.75 15.91V19.2C2.75 20.79 3.21 21.25 4.8 21.25H7.2C8.79 21.25 9.25 20.79 9.25 19.2V15.91C9.25 14.32 8.79 13.86 7.2 13.86H4.8Z"
        fill="#292D32"
      />
      <path
        d="M19.2 22.75H16.8C14.38 22.75 13.25 21.62 13.25 19.2V15.91C13.25 13.49 14.38 12.36 16.8 12.36H19.2C21.62 12.36 22.75 13.49 22.75 15.91V19.2C22.75 21.62 21.62 22.75 19.2 22.75ZM16.8 13.86C15.21 13.86 14.75 14.32 14.75 15.91V19.2C14.75 20.79 15.21 21.25 16.8 21.25H19.2C20.79 21.25 21.25 20.79 21.25 19.2V15.91C21.25 14.32 20.79 13.86 19.2 13.86H16.8Z"
        fill="#292D32"
      />
    </svg>
  );
