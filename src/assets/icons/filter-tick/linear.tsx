  ...
  return (
    ...
    >
      <path
        ...
        strokeMiterlimit="10"
        strokeWidth="1.5"
        d="M21.63 14.75c0 .89-.24 1.73-.68 2.45a4.735 4.735 0 01-4.07 2.3c-.94 0-1.82-.28-2.56-.77-.62-.38-1.13-.91-1.5-1.53-.44-.72-.69-1.56-.69-2.45 0-2.62 2.13-4.75 4.75-4.75.36 0 .71.04 1.04.12a4.74 4.74 0 013.71 4.63z"
      ></path>
      <path
        stroke="#292D32"
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth="1.5"
        d="M15.03 14.75l1.17 1.17 2.53-2.34"
      ></path>
      <path
        stroke="#292D32"
        strokeLinecap="round"
