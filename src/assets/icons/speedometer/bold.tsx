...
export const Bold: FC<IBoldProps> = ({ className }) => {
  return (
    ...
    >
      ...
      />
      <path
        d="M12.0001 22C14.143 22 15.8801 20.2629 15.8801 18.12C15.8801 15.9771 14.143 14.24 12.0001 14.24C9.85725 14.24 8.12012 15.9771 8.12012 18.12C8.12012 20.2629 9.85725 22 12.0001 22Z"
        fill="#292D32"
      />
      <path
