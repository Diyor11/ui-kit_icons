  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeMiterlimit="10"
        strokeWidth="1.5"
        d="M19.14 2.59l-3.63 3.63c-.14.14-.28.41-.3.61l-.2 1.39c-.07.5.28.85.78.78l1.39-.2c.19-.03.47-.16.61-.3l3.63-3.63c.63-.63.92-1.35 0-2.27-.93-.94-1.65-.64-2.28-.01zM18.62 3.11c.31 1.1 1.17 1.96 2.27 2.27"
      ></path>
      <path
        stroke="#292D32"
        strokeLinecap="round"
