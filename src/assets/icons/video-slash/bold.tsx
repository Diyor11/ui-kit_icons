...
export const Bold: FC<IBoldProps> = ({ className }) => {
  return (
    ...
    >
      ...
      />
      <path
        d="M22.3802 8.38001V15.62C22.3802 17.05 21.6802 17.62 21.2802 17.83C21.0902 17.93 20.7902 18.04 20.4202 18.04C19.9902 18.04 19.4602 17.9 18.8402 17.46L17.3602 16.42C17.2902 18.63 16.5902 19.89 15.0002 20.42C14.3602 20.65 13.5702 20.75 12.6202 20.75H6.62016C6.38016 20.75 6.15016 20.74 5.91016 20.71L15.0002 11.63L20.6502 5.98001C20.9102 6.00001 21.1202 6.08001 21.2802 6.17001C21.6802 6.38001 22.3802 6.95001 22.3802 8.38001Z"
        fill="#292D32"
      />
    </svg>
  );
