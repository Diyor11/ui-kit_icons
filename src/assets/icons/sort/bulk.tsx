...
export const Bulk: FC<IBulkProps> = ({ className }) => {
  return (
    ...
    >
      ...
      />
      <path
        d="M13.3299 17H10.6599C10.2499 17 9.90991 16.66 9.90991 16.25C9.90991 15.84 10.2499 15.5 10.6599 15.5H13.3299C13.7399 15.5 14.0799 15.84 14.0799 16.25C14.0799 16.66 13.7499 17 13.3299 17Z"
        fill="#292D32"
      />
    </svg>
  );
