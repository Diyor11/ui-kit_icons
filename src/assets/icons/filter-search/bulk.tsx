...
export const Bulk: FC<IBulkProps> = ({ className }) => {
  return (
    ...
    >
      <path
        d="M19.75 15.41L18.9 14.56C19.34 13.89 19.6 13.1 19.6 12.24C19.6 9.89999 17.7 8 15.36 8C13.02 8 11.12 9.89999 11.12 12.24C11.12 14.58 13.02 16.48 15.36 16.48C16.22 16.48 17.02 16.22 17.68 15.78L18.53 16.63C18.7 16.8 18.92 16.88 19.14 16.88C19.36 16.88 19.58 16.8 19.75 16.63C20.08 16.29 20.08 15.74 19.75 15.41Z"
        fill="#292D32"
      />
      <path
        opacity="0.4"
