  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeMiterlimit="10"
        strokeWidth="1.5"
        d="M17.08 11.89l-3.54 3.54c-.14.14-.27.4-.3.59l-.19 1.35c-.07.49.27.83.76.76l1.35-.19c.19-.03.46-.16.59-.3l3.54-3.54c.61-.61.9-1.32 0-2.22-.89-.89-1.6-.6-2.21.01zM16.58 12.39c.3 1.08 1.14 1.92 2.22 2.22"
      ></path>
    </svg>
  );
};
