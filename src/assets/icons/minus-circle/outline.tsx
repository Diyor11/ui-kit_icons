...
export const Outline: FC<IOutlineProps> = ({ className }) => {
  return (
    ...
    >
      <path
        d="M11.92 22.75C6.00004 22.75 1.17004 17.93 1.17004 12C1.17004 6.07 6.00004 1.25 11.92 1.25C17.84 1.25 22.67 6.07 22.67 12C22.67 17.93 17.85 22.75 11.92 22.75ZM11.92 2.75C6.82004 2.75 2.67004 6.9 2.67004 12C2.67004 17.1 6.82004 21.25 11.92 21.25C17.02 21.25 21.17 17.1 21.17 12C21.17 6.9 17.02 2.75 11.92 2.75Z"
        fill="#292D32"
      />
      <path
