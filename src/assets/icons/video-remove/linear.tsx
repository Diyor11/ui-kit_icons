  ...
  return (
    ...
    >
      <path
        ...
        strokeWidth="1.5"
        d="M22 9v6c0 .23 0 .45-.02.67-.04-.06-.09-.12-.14-.17-.81-.93-2.01-1.5-3.34-1.5-1.26 0-2.41.52-3.23 1.36a4.5 4.5 0 00-.62 5.46c.23.38.52.73.86 1.02.05.05.1.09.16.14-.21.02-.44.02-.67.02H9c-5 0-7-2-7-7V9c0-5 2-7 7-7h6c5 0 7 2 7 7zM2.52 7.11h18.96M8.52 2.11v4.86M15.48 2.11v4.41"
      ></path>
      <path
        stroke="#292D32"
        strokeLinecap="round"
