...
export const Bold: FC<IBoldProps> = ({ className }) => {
  return (
    ...
    >
      <path
        d="M9.66984 13.92C8.92984 13.92 8.33984 14.52 8.33984 15.26C8.33984 16 8.93984 16.59 9.66984 16.59C10.4098 16.59 11.0098 15.99 11.0098 15.26C11.0098 14.52 10.4098 13.92 9.66984 13.92Z"
        fill="#292D32"
      />
      <path
